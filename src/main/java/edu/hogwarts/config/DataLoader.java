...
public class DataLoader implements ApplicationRunner {
    ...
    private Set<Student> createStudents() {
        ...
        students.add(createStudent("Harry",  "James", "Potter", LocalDate.of(1980, 7, 31),(House) houseRepository.findByName("Gryffindor").orElse(null), false, 1991, 1998, true));
        students.add(createStudent("Hermione", "Jean", "Granger", LocalDate.of(1979, 9, 19),(House) houseRepository.findByName("Gryffindor").orElse(null), true, 1991, 1998, true));
        students.add(createStudent("Ron", "Bilius", "Weasley", LocalDate.of(1980, 3, 1),(House) houseRepository.findByName("Gryffindor").orElse(null), false, 1991, 1998, true));
        students.add(createStudent("Draco", "Lucius", "Malfoy", LocalDate.of(1980, 6, 5),(House) houseRepository.findByName("Slytherin").orElse(null), false, 1991, 1998, false));
        students.add(createStudent("Neville", "Samwise", "Longbottom", LocalDate.of(1980, 7, 30),(House) houseRepository.findByName("Gryffindor").orElse(null), false, 1991, 1998, true));
        students.add(createStudent("Luna", null, "Lovegood", LocalDate.of(1981, 2, 13),(House) houseRepository.findByName("Ravenclaw").orElse(null), false, 1992, 1999, true));
        students.add(createStudent("Ginny", "Molly", "Weasley", LocalDate.of(1981, 8, 11),(House) houseRepository.findByName("Gryffindor").orElse(null), true, 1992, 1999, true));
        students.add(createStudent("Fred",  null, "Weasley", LocalDate.of(1978, 4, 1), (House) houseRepository.findByName("Gryffindor").orElse(null), false, 1989, 1996, true));
        students.add(createStudent("George", null, "Weasley", LocalDate.of(1978, 4, 1),(House) houseRepository.findByName("Gryffindor").orElse(null), false, 1989, 1996, true));
        students.add(createStudent("Cho", null, "Chang", LocalDate.of(1979, 9, 30),(House) houseRepository.findByName("Ravenclaw").orElse(null), false, 1991, 1998, true));

        studentRepository.saveAll(students);
        return students;
    }

    private Student createStudent(String firstName, String middleName, String lastName, LocalDate dateOfBirth, House house, boolean prefect, int enrollmentYear, int graduationYear, boolean graduated) {
